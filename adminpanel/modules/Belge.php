...
class Belge  extends Settings{
    ...
    public  $modulName;
    private $ktable = "belge_kategori";
    private $ktablelang = "belge_kategori_lang";
    private $table;
    private $tablelang;
    public  $tablist;
    public $modul_info;
    ...
    public function __construct($settings)
    {
        ...
        $this->tablist = array(
            array("title" => "Belge Listesi", "href" => "liste", "icon" => "mdi mdi-view-sequential"),
    ...
    public function liste($id=null)
    {
        ...
        $this->SayfaBaslik = "Belge Listesi";
        ...
        $text .= $pagelist->PageList(array(
            ...
            'page'=>$this->table,
            'resim'=>true,
            "place"=>"belgelerde ara",
            "showing"=>$showing,
            "toplamVeri"=>$toplamVeri,
            "search"=>true,
            'button' => array(array('title'=>'Belge Ekle','href'=>$this->BaseAdminURL($this->modulName.'/ekle&kid='.$id),"class"=>"btn btn-success")),
            'p'=>array(
            ...
            'baslik'=>array(
                array('title'=>'Belge Başlığı','width'=>'20%'),
    ...
    public function ekle($id=null)
    {
        ...
        $this->SayfaBaslik = 'Belge '.(($id) ? "Düzenle" : "Ekle");
        $text = '';
        $tabForm = array();
        ...
        foreach ($this->settings->lang('lang') as $dil=>$title):
            $tabForm[$dil]['text']  = $form->input(array('value'=>((isset($data[$dil]['baslik']) ? $this->temizle($data[$dil]['baslik']) :'')),'title'=>'Belge Başlığı','lang'=>$dil,'name'=>'baslik'));
        ...
        $text.= $form->file2(array('url'=>$this->BaseURL('upload')."/".$this->modulName,'folder'=>$this->modulName,'title'=>'Belge Resmi','name'=>'SayfaResim','resimBoyut'=>$this->modul_image_size($this->modul_info["id"]),'src'=>((isset($data['tr']['resim'])) ? $data['tr']['resim'] :'')));
