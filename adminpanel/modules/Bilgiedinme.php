...
class Bilgiedinme  extends Settings{
    ...
    public function __construct($settings)
    {
        ...
        $this->tablist = array(
            array("title" => "Bilgi Edinme Formları", "href" => "liste", "icon" => "mdi mdi-view-sequential"),
    ...
    public function liste($id=null)
    {
        ...
        $text .= $pagelist->PageList(array(
            ...
            "search"=>true,
            //'button' => array(array('title'=>'Bağlantı Ekle','href'=>$this->BaseAdminURL($this->modulName.'/ekle'),"class"=>"btn btn-success")),
            'p'=>array(
            ...
            'buton'=> array(
                array("disable_delete"=>true,'type'=>'detay','align'=>"center", 'title'=>'Detay','class'=>'btn bg-olive','dataname'=>'detay', "data-icon"=>"ti-eye", "modul"=>$this->table),
            ...
            'baslik'=>array(
                ...
                array('title'=>'Başvuru Tarihi','width'=>'10%'),
                array('title'=>'Detaylar','width'=>'5%', "align"=>"center"),
    ...
    {
        $this->SayfaBaslik = 'Bağlantı '.(($id) ? "Düzenle" : "Ekle");
        $text = '';
        $tabForm = array();
