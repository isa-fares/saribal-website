...
class Egitim  extends Settings{
    ...
    public function __construct($settings)
    {
        ...
        $this->tablist = array(
            array("title" =>"Eğitim Merkezleri", "href" => "liste", "icon" => "mdi mdi-view-sequential"),
    ...
    public function liste($id=null)
    {
        ...
        $this->SayfaBaslik = "Eğitim Merkezleri";
        ...
        $text .= $pagelist->PageList(array(
            ...
            'button' => array(array('title'=>'Eğitim Merkezi Ekle','href'=>$this->BaseAdminURL($this->modulName.'/ekle'),"class"=>"btn btn-success")),
            'p'=>array(
    ...
    public function ekle($id=null)
    {
        ...
        foreach ($this->settings->lang('lang') as $dil=>$title):
            ...
            $tabForm[$dil]['text'] .= $form->textEditor(array('value'=>((isset($data[$dil]['detay']) ? $this->temizle($data[$dil]['detay']) :'')),'title'=>'Meslek Alanları','name'=>'detay','lang'=>$dil,'height' => '350'));
        endforeach;
        ...
        $text  .= $form->input(array("icon"=>"fa fa-globe",'value'=>((isset($data["tr"]['site']) ? $this->temizle($data["tr"]['site']) :'')),'title'=>'Websitesi','name'=>'site'));
        ...
        foreach ($this->settings->lang('lang') as $dil=>$title):
            ...
            if($dil == "tr"):
                $post[$dil] = array(
                    ...
                    'site'=> $this->kirlet($this->_POST('site')),
