...
class Gorus  extends Settings{


    public  $modulName = 'gorus';
    private $table;
    private $tablelang;
    ...
    public function liste($id=null)
    {
        ...
        $this->SayfaBaslik = 'Katılımcı Görüşleri';
        ...
        return $pagelist->PageList(array(
            ...
            'page'=>$this->table,
            "resim"=>true,
            "place"=>"yorum yapan, yorum",
            "showing"=>$showing,
            "toplamVeri"=>$toplamVeri,
            "search"=>true,
            'button' => array(array('title'=>'Yorum Ekle','href'=>$this->BaseAdminURL($this->modulName.'/ekle'),"class"=>"btn btn-success")),
            ...
            'baslik'=>array(
                ...
                array('title'=>'Adı Soyadı','width'=>'40%'),
    ...
    public function ekle($id=null)
    {
        ...
        $text.= $form->file(array('url'=>$this->BaseURL('upload')."/".$this->modulName,'folder'=>$this->modulName,'title'=>'Resim','name'=>'resim','resimBoyut'=>$this->settings->boyut($this->modulName),'src'=>((isset($data['tr']['resim'])) ? $data['tr']['resim'] :'')));
