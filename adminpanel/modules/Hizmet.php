...
class Hizmet  extends Settings{
    ...
    public function __construct($settings)
    {
        ...
        $this->tablist = array(
            array("title" => "Hizmetler Listesi", "href" => "liste", "icon" => "mdi mdi-view-sequential"),
            array("title" => "Hizmetler Modül Ayarları", "href" => "settings", "icon" => "mdi mdi-settings")
        );
    ...
    public function liste($id=null)
    {
        ...
        $text .= $pagelist->PageList(array(
            ...
            "search"=>true,
            'button' => array(array('title'=>'Hizmet Ekle','href'=>$this->BaseAdminURL($this->modulName.'/ekle'),"class"=>"btn btn-success")),
            'p'=>array(
    ...
    {
        $this->SayfaBaslik = 'Hizmet '.(($id) ? "Düzenle" : "Ekle");
        $text = '';
        $tabForm = array();
