...
'));
    ...
    public function mpkategoriEkle($id=null)
    {
        ...
        $form = new Form($this->settings);
        $tabs = new Tabs($this->settings);
        $text .= $form->formOpen(array('method'=>'POST','icbaslik'=>$this->icbaslik,'action'=>  $this->BaseAdminURL($this->modulName.'/mpkategoriKaydet'.((isset($id)) ? '/'.$id :'')),'fileUpload'=>true,'id'=>'form_sample_3','class'=>''));
    ...
    public function  mpkategoriKaydet($id=null)// Kategori Kaydet
    {
        ...
        $this->RedirectURL($this->BaseAdminURL($this->modulName.'/mpkategoriListesi'.(($this->_POST('kid_tr')) ? "/".$this->_POST('kid_tr'):'.html')));
