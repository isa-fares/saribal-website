...
class Sorular  extends Settings{
    ...
    public function __construct($settings)
    {
        ...
        $this->tablist = array(
            array("title" => "Soru Listesi", "href" => "liste", "icon" => "mdi mdi-view-sequential"),
            //array("title" => "Soru Modül Ayarları", "href" => "settings", "icon" => "mdi mdi-settings")
        );
    ...
    public function liste($id=null)
    {
        ...
        $text .= $pagelist->PageList(array(
            ...
            "search"=>true,
            'button' => array(array('title'=>'Soru Ekle','href'=>$this->BaseAdminURL($this->modulName.'/ekle'),"class"=>"btn btn-success")),
            'p'=>array(
