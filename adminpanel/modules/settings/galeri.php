        ...
        <div class="box">
            ...
            <div class="box-body">
                <div class="row">
                        ...
                        <div class="form-group row mb-1">
                            ...
                            <div class="col-sm-12">
                                <div class="form-control-feedback" style="padding:8px 0 0; font-size:12px;">
                                    <i class="fa fa-info-circle"></i> Websitenizin anasayfasında bulunan Foto Galeri bölümünü kapatıp açabilirsiniz.</div>
                            </div>
                    ...
                    <div class="col-md-4">
                        <?=$form->input(array('value'=>((isset($data['ek']) ? $this->temizle($data['ek']) :'')),'title'=>'Resim Boyutları', 'name'=>'ek'));?>
                    </div>
