        ...
        <div class="box">
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <?=$form->input(array('value'=>((isset($data['big']) ? $this->temizle($data['big']) :'')),'title'=>'Resim Boyutu', 'name'=>'big', "help"=>"Sayfanın detayında gözükecek banner resmin boyutudur."));?>
                    </div>


                    <div class="col-md-6">
                        <?=$form->input(array('value'=>((isset($data['ek']) ? $this->temizle($data['ek']) :'')),'title'=>'Çoklu Resim Boyutu', 'name'=>'ek', "help"=>"Sayfa detayında küçük halde gözüken resimlerin boyutu"));?>
                    </div>
                </div>
