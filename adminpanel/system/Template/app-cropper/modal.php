...
$unique = $uniqueId;
$modalLabel = 'Resim Kırpma Editorü';
...
echo '<div class="modal fade" tabindex="-1" role="dialog" id="cropper-modal-'. $unique .'">'
    ...
    .'Çift tıklama: "resim taşı" veya "tekrar seç" arasında geçiş yap.'
    .'</div>'
    .'</div>'
    .'<div class="col-sm-4">'
    .'<div class="input-group input-group-sm width-warning">'
    .'<label class="input-group-addon" for="dataWidth-'. $unique .'">Gen. ('. $cropWidth .'px)</label>'
    ...
    .'<label class="input-group-addon" for="dataHeight-'. $unique .'">Yük. ('. $cropHeight .'px)</label>'
    ...
    .'<input type="file" id="cropper-input-'. $unique .'" title="Araştır" accept="image/*">'
    .'</span>&nbsp;'
    .'<div class="btn-group">'
    ...
    .'</div>'
    .'</div>'
    .'<button type="button" id="close-button-'. $unique .'" class="btn btn-danger pull-right" data-dismiss="modal">'. $closeLabel .'</button>'
    .'<button type="button" id="crop-button-'. $unique .'" class="btn btn-success pull-right">'. $cropLabel .'</button>'
    .'</div>'
    .'</div>'
    .'</div>'
    .'</div>';