                ...
                return this.each(function () {
                    ...
                    if (settings.options.sniffHtml) {
                        ...
                        if ($this.attr("max") !== undefined || $this.attr("aria-valuemax") !== undefined) {
                            ...
                            message = "Maximum'" + max + " Girebilirsiniz.'<!-- data-validation-max-message to override -->";
                        ...
                        if ($this.attr("min") !== undefined || $this.attr("aria-valuemin") !== undefined) {
                            ...
                            message = "Minimum '" + min + " Girmelisiniz'<!-- data-validation-min-message to override -->";
                        ...
                        if ($this.attr("maxlength") !== undefined) {
                            message = "Maximum '" + $this.attr("maxlength") + "' karakter girebilirsiniz.<!-- data-validation-maxlength-message to override -->";
                        ...
                        if ($this.attr("minlength") !== undefined) {
                            message = "Minimum '" + $this.attr("minlength") + "' karakter girmelisiniz.<!-- data-validation-minlength-message to override -->";
                        ...
                        if ($this.attr("type") !== undefined && $this.attr("type").toLowerCase() === "email") {
                            message = "Geçersiz email adresi<!-- data-validation-email-message to override -->";
                        ...
                        if ($this.attr("minchecked") !== undefined) {
                            message = "Minimum '" + $this.attr("minchecked") + "' seçenek seçmelisiniz.<!-- data-validation-minchecked-message to override -->";
                        ...
                        if ($this.attr("maxchecked") !== undefined) {
                            message = "Maximum '" + $this.attr("maxchecked") + "' seçenek seçebilirsiniz.<!-- data-validation-maxchecked-message to override -->";
        ...
        , validatorTypes: {
            ...
            , max: {
                ...
                , init: function ($this, name) {
                    ...
                    result.message = "Maximum '" + result.max + "' Girebilirsiniz.";
                    if ($this.data("validation" + name + "Message")) {
            ...
            , min: {
                ...
                , init: function ($this, name) {
                    ...
                    result.message = "Minimum '" + result.min + "' Girmelisiniz.";
                    if ($this.data("validation" + name + "Message")) {
                        result.message = $this.data("validation" + name + "Message");
                    }
                    return result;
            ...
            , maxlength: {
                ...
                , init: function ($this, name) {
                    ...
                    result.message = "Maximum '" + result.maxlength + "' karakter girebilirsiniz.";
                    if ($this.data("validation" + name + "Message")) {
                        result.message = $this.data("validation" + name + "Message");
                    }
                    return result;
            ...
            , minlength: {
                ...
                , init: function ($this, name) {
                    ...
                    result.message = "Minimum '" + result.minlength + "' karakter girmelisiniz.";
                    if ($this.data("validation" + name + "Message")) {
                        result.message = $this.data("validation" + name + "Message");
                    }
                    return result;
            ...
            , maxchecked: {
                ...
                , init: function ($this, name) {
                    ...
                    var message = "Maximum '" + result.maxchecked + "' seçenek seçebilirsiniz.";
                    if ($this.data("validation" + name + "Message")) {
                        message = $this.data("validation" + name + "Message");
                    }
                    result.message = message;
            ...
            , minchecked: {
                ...
                , init: function ($this, name) {
                    ...
                    var message = "Minimum '" + result.minchecked + "' seçenek seçmelisiniz.";
                    if ($this.data("validation" + name + "Message")) {
                        message = $this.data("validation" + name + "Message");
                    }
                    result.message = message;
            ...
            , number: {
                ...
                , init: function ($this, name) {
                    ...
                    result.message = "Rakam girmelisiniz.";
