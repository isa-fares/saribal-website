    ...
    <div class="col-12">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li><a class="active" href="#fa-icons" data-toggle="tab">Font Awesome</a></li>
                <li><a href="#glyphicons" data-toggle="tab">Glyphicons</a></li>
                <li><a href="#material" data-toggle="tab">Material Icons</a></li>
                <li><a href="#themify" data-toggle="tab">Themify Icons</a></li>
            </ul>
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="fa-icons">
                    ...
                    <section id="web-application">
                        <h4 class="page-header">Web Uygulama iconları</h4>
                    ...
                    <section id="accessibility">
                        <h4 class="page-header">Erişim iconları</h4>
                    ...
                    <div class="clearfix"></div>
                    <section id="hand">
                        <h4 class="page-header">El iconları</h4>
                    ...
                    <section id="transportation">
                        <h4 class="page-header">Taşıt iconları</h4>
                    ...
                    <section id="gender">
                        <h4 class="page-header">Cinsiyet iconları</h4>
                    ...
                    <section id="file-type">
                        <h2 class="page-header">Dosya Türü iconları</h2>
                    ...
                    <section id="spinner">
                        <h2 class="page-header">Loading iconları</h2>
                    ...
                    <section id="form-control">
                        <h4 class="page-header">Form Kontrol iconları</h4>
                    ...
                    <section id="payment">
                        <h4 class="page-header">Ödeme iconları</h4>
                    ...
                    <section id="chart">
                        <h4 class="page-header">Grafik iconları</h4>
                    ...
                    <section id="currency">
                        <h4 class="page-header">Para birimi iconları</h4>
                    ...
                    <section id="text-editor">
                        <h4 class="page-header">Metin iconları</h4>
                    ...
                    <section id="directional">
                        <h4 class="page-header">Yön iconları</h4>
                    ...
                    <section id="video-player">
                        <h4 class="page-header">Video iconları</h4>
                    ...
                    <div class="clearfix"></div>
                    <section id="brand">
                        <h4 class="page-header">Marka ikonları</h4>
                    ...
                    <div class="clearfix"></div>
                    <section id="medical">
                        <h4 class="page-header">Sağlık iconları</h4>
                        <div class="row fontawesome-icon-list m-0">
                            <div class="fa-hover col-xl-3 col-lg-4 col-md-6 col-12"><i class="fa fa-fw fa-ambulance"></i> fa-ambulance</div>
                ...
                <div class="tab-pane" id="ionicons">
                    <section>
                        ...
                        <div class="clearfix ion-icon-list">

                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ionic" data-pack="default" data-tags="badass, framework, sexy, hawt"></i> ion-ionic</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-arrow-up-a" data-pack="default" data-tags=""></i> ion-arrow-up-a</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-arrow-right-a" data-pack="default" data-tags=""></i> ion-arrow-right-a</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-arrow-down-a" data-pack="default" data-tags=""></i> ion-arrow-down-a</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-arrow-left-a" data-pack="default" data-tags=""></i> ion-arrow-left-a</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-arrow-up-b" data-pack="default" data-tags=""></i> ion-arrow-up-b</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-arrow-right-b" data-pack="default" data-tags=""></i> ion-arrow-right-b</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-arrow-down-b" data-pack="default" data-tags=""></i> ion-arrow-down-b</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-arrow-left-b" data-pack="default" data-tags=""></i> ion-arrow-left-b</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-arrow-up-c" data-pack="default" data-tags=""></i> ion-arrow-up-c</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-arrow-right-c" data-pack="default" data-tags=""></i> ion-arrow-right-c</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-arrow-down-c" data-pack="default" data-tags=""></i> ion-arrow-down-c</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-arrow-left-c" data-pack="default" data-tags=""></i> ion-arrow-left-c</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-arrow-return-right" data-pack="default" data-tags=""></i> ion-arrow-return-right</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-arrow-return-left" data-pack="default" data-tags=""></i> ion-arrow-return-left</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-arrow-swap" data-pack="default" data-tags="switch, flip"></i> ion-arrow-swap</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-arrow-shrink" data-pack="default" data-tags="pinch"></i> ion-arrow-shrink</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-arrow-expand" data-pack="default" data-tags="fullscreen"></i> ion-arrow-expand</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-arrow-move" data-pack="default" data-tags="drag"></i> ion-arrow-move</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-arrow-resize" data-pack="default" data-tags="drag"></i> ion-arrow-resize</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-chevron-up" data-pack="default" data-tags="arrow, up"></i> ion-chevron-up</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-chevron-right" data-pack="default" data-tags="arrow, right"></i> ion-chevron-right</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-chevron-down" data-pack="default" data-tags="arrow, down"></i> ion-chevron-down</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-chevron-left" data-pack="default" data-tags="arrow, left"></i> ion-chevron-left</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-navicon-round" data-pack="default" data-tags="menu, hamburger, slide menu"></i> ion-navicon-round</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-navicon" data-pack="default" data-tags="menu, hamburger, slide menu"></i> ion-navicon</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-drag" data-pack="default" data-tags="reorder, move, drag"></i> ion-drag</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-log-in" data-pack="default" data-tags="sign in, "></i> ion-log-in</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-log-out" data-pack="default" data-tags="sign out"></i> ion-log-out</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-checkmark-round" data-pack="default" data-tags="complete, finished, success, on"></i> ion-checkmark-round</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-checkmark" data-pack="default" data-tags="complete, finished, success, on"></i> ion-checkmark</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-checkmark-circled" data-pack="default" data-tags="complete, finished, success, on"></i> ion-checkmark-circled</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-close-round" data-pack="default" data-tags="delete, trash, kill, x"></i> ion-close-round</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-close" data-pack="default" data-tags="delete, trash, kill, x"></i> ion-close</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-close-circled" data-pack="default" data-tags="delete, trash, kill, x"></i> ion-close-circled</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-plus-round" data-pack="default" data-tags="add, include, new, invite, +"></i> ion-plus-round</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-plus" data-pack="default" data-tags="add, include, new, invite, +"></i> ion-plus</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-plus-circled" data-pack="default" data-tags="add, include, new, invite, +"></i> ion-plus-circled</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-minus-round" data-pack="default" data-tags="hide, remove, minimize, -"></i> ion-minus-round</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-minus" data-pack="default" data-tags="hide, remove, minimize, -"></i> ion-minus</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-minus-circled" data-pack="default" data-tags="hide, remove, minimize, -"></i> ion-minus-circled</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-information" data-pack="default" data-tags="help, more, tooltip"></i> ion-information</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-information-circled" data-pack="default" data-tags="help, more, tooltip"></i> ion-information-circled</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-help" data-pack="default" data-tags="question, ?"></i> ion-help</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-help-circled" data-pack="default" data-tags="question, ?"></i> ion-help-circled</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-backspace-outline" data-pack="default" data-tags="delete, remove, back"></i> ion-backspace-outline</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-backspace" data-pack="default" data-tags="delete, remove, back"></i> ion-backspace</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-help-buoy" data-pack="default" data-tags="question, ?"></i> ion-help-buoy</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-asterisk" data-pack="default" data-tags="favorite, mark, star"></i> ion-asterisk</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-alert" data-pack="default" data-tags="attention, warning, notice, !, exclamation"></i> ion-alert</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-alert-circled" data-pack="default" data-tags="attention, warning, notice, !, exclamation"></i> ion-alert-circled</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-refresh" data-pack="default" data-tags="reload, renew"></i> ion-refresh</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-loop" data-pack="default" data-tags="refresh"></i> ion-loop</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-shuffle" data-pack="default" data-tags="random"></i> ion-shuffle</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-home" data-pack="default" data-tags="house"></i> ion-home</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-search" data-pack="default" data-tags="magnifying glass"></i> ion-search</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-flag" data-pack="default" data-tags="favorite, mark, star"></i> ion-flag</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-star" data-pack="default" data-tags="favorite"></i> ion-star</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-heart" data-pack="default" data-tags="love"></i> ion-heart</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-heart-broken" data-pack="default" data-tags="love"></i> ion-heart-broken</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-gear-a" data-pack="default" data-tags="settings, options, cog"></i> ion-gear-a</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-gear-b" data-pack="default" data-tags="settings, options, cog"></i> ion-gear-b</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-toggle-filled" data-pack="default" data-tags="settings, options, switch"></i> ion-toggle-filled</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-toggle" data-pack="default" data-tags="settings, options, switch"></i> ion-toggle</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-settings" data-pack="default" data-tags="options, tools"></i> ion-settings</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-wrench" data-pack="default" data-tags="settings, options, tools"></i> ion-wrench</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-hammer" data-pack="default" data-tags="settings, options, tools"></i> ion-hammer</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-edit" data-pack="default" data-tags="change, update, write, type, pencil"></i> ion-edit</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-trash-a" data-pack="default" data-tags="delete, remove, dump"></i> ion-trash-a</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-trash-b" data-pack="default" data-tags="delete, remove, dump"></i> ion-trash-b</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-document" data-pack="default" data-tags="paper, file"></i> ion-document</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-document-text" data-pack="default" data-tags="paper, file"></i> ion-document-text</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-clipboard" data-pack="default" data-tags="write"></i> ion-clipboard</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-scissors" data-pack="default" data-tags="cut"></i> ion-scissors</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-funnel" data-pack="default" data-tags="sort"></i> ion-funnel</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-bookmark" data-pack="default" data-tags="favorite, tag, save"></i> ion-bookmark</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-email" data-pack="default" data-tags="snail, mail, inbox"></i> ion-email</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-email-unread" data-pack="default" data-tags="snail, mail, inbox"></i> ion-email-unread</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-folder" data-pack="default" data-tags="snail, mail"></i> ion-folder</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-filing" data-pack="default" data-tags="mail"></i> ion-filing</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-archive" data-pack="default" data-tags="mail"></i> ion-archive</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-reply" data-pack="default" data-tags="mail, undo"></i> ion-reply</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-reply-all" data-pack="default" data-tags="mail"></i> ion-reply-all</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-forward" data-pack="default" data-tags="mail, redo"></i> ion-forward</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-share" data-pack="default" data-tags="outbound"></i> ion-share</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-paper-airplane" data-pack="default" data-tags="outbound, mail, letter, send"></i> ion-paper-airplane</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-link" data-pack="default" data-tags="chain, anchor, href, attach"></i> ion-link</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-paperclip" data-pack="default" data-tags="attach"></i> ion-paperclip</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-compose" data-pack="default" data-tags="write, compose, type"></i> ion-compose</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-briefcase" data-pack="default" data-tags="store, organize"></i> ion-briefcase</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-medkit" data-pack="default" data-tags="health"></i> ion-medkit</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-at" data-pack="default" data-tags="@"></i> ion-at</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-pound" data-pack="default" data-tags="hashtag, #"></i> ion-pound</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-quote" data-pack="default" data-tags="chat, quotation"></i> ion-quote</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-cloud" data-pack="default" data-tags="storage"></i> ion-cloud</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-upload" data-pack="default" data-tags="storage, cloud"></i> ion-upload</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-more" data-pack="default" data-tags="circles"></i> ion-more</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-grid" data-pack="default" data-tags="menu"></i> ion-grid</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-calendar" data-pack="default" data-tags="date, time, month, year"></i> ion-calendar</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-clock" data-pack="default" data-tags="time, watch, hours, minutes, seconds"></i> ion-clock</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-compass" data-pack="default" data-tags="location, directions, navigation"></i> ion-compass</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-pinpoint" data-pack="default" data-tags="gps, navigation"></i> ion-pinpoint</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-pin" data-pack="default" data-tags="gps, navigation"></i> ion-pin</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-navigate" data-pack="default" data-tags="gps, location pin"></i> ion-navigate</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-location" data-pack="default" data-tags="gps, navigation, pin"></i> ion-location</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-map" data-pack="default" data-tags="gps, navigation, pin"></i> ion-map</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-lock-combination" data-pack="default" data-tags="padlock, security"></i> ion-lock-combination</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-locked" data-pack="default" data-tags="padlock, security"></i> ion-locked</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-unlocked" data-pack="default" data-tags="padlock, security"></i> ion-unlocked</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-key" data-pack="default" data-tags="access"></i> ion-key</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-arrow-graph-up-right" data-pack="default" data-tags="stats"></i> ion-arrow-graph-up-right</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-arrow-graph-down-right" data-pack="default" data-tags="stats"></i> ion-arrow-graph-down-right</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-arrow-graph-up-left" data-pack="default" data-tags="stats"></i> ion-arrow-graph-up-left</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-arrow-graph-down-left" data-pack="default" data-tags="stats"></i> ion-arrow-graph-down-left</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-stats-bars" data-pack="default" data-tags="data"></i> ion-stats-bars</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-connection-bars" data-pack="default" data-tags="data, stats"></i> ion-connection-bars</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-pie-graph" data-pack="default" data-tags="stats"></i> ion-pie-graph</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-chatbubble" data-pack="default" data-tags="talk"></i> ion-chatbubble</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-chatbubble-working" data-pack="default" data-tags="talk"></i> ion-chatbubble-working</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-chatbubbles" data-pack="default" data-tags="talk"></i> ion-chatbubbles</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-chatbox" data-pack="default" data-tags="talk"></i> ion-chatbox</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-chatbox-working" data-pack="default" data-tags="talk"></i> ion-chatbox-working</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-chatboxes" data-pack="default" data-tags="talk"></i> ion-chatboxes</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-person" data-pack="default" data-tags="users, staff, head, human"></i> ion-person</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-person-add" data-pack="default" data-tags="users, staff, head, human, member, new"></i> ion-person-add</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-person-stalker" data-pack="default" data-tags="people, human, users, staff"></i> ion-person-stalker</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-woman" data-pack="default" data-tags="female, lady, girl, dudette"></i> ion-woman</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-man" data-pack="default" data-tags="male, guy, boy, dude"></i> ion-man</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-female" data-pack="default" data-tags="lady, girl, dudette"></i> ion-female</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-male" data-pack="default" data-tags="male, guy, boy, dude"></i> ion-male</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-transgender" data-pack="default" data-tags=""></i> ion-transgender</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-fork" data-pack="default" data-tags="food, drink, eat"></i> ion-fork</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-knife" data-pack="default" data-tags="food, drink, eat"></i> ion-knife</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-spoon" data-pack="default" data-tags="food, drink, eat"></i> ion-spoon</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-soup-can-outline" data-pack="default" data-tags="food, drink, eat"></i> ion-soup-can-outline</div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-soup-can" data-pack="default" data-tags="food, drink, eat"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-beer" data-pack="default" data-tags="food, drink, eat"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-wineglass" data-pack="default" data-tags="food, drink, eat"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-coffee" data-pack="default" data-tags="food, drink, eat, caffeine"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-icecream" data-pack="default" data-tags="food, drink, eat"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-pizza" data-pack="default" data-tags="food, drink, eat"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-power" data-pack="default" data-tags="on, off"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-mouse" data-pack="default" data-tags="computer"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-battery-full" data-pack="default" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-battery-half" data-pack="default" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-battery-low" data-pack="default" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-battery-empty" data-pack="default" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-battery-charging" data-pack="default" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-wifi" data-pack="default" data-tags="internet, connection"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-bluetooth" data-pack="default" data-tags="connection, cloud"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-calculator" data-pack="default" data-tags="math, arithmatic, numbers, addition, subtraction"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-camera" data-pack="default" data-tags="photo"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-eye" data-pack="default" data-tags="view, see, creeper"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-eye-disabled" data-pack="default" data-tags="view, see, creeper"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-flash" data-pack="default" data-tags="lightning, weather, whether"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-flash-off" data-pack="default" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-qr-scanner" data-pack="default" data-tags="reader"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-image" data-pack="default" data-tags="photo"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-images" data-pack="default" data-tags="photo"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-wand" data-pack="default" data-tags="images, levels, light, dark, settings"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-contrast" data-pack="default" data-tags="images, levels, light, dark, settings"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-aperture" data-pack="default" data-tags="images, levels, light, dark, settings"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-crop" data-pack="default" data-tags="images, levels, light, dark, settings"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-easel" data-pack="default" data-tags="images, art, create, color"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-paintbrush" data-pack="default" data-tags="images, art, create, color"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-paintbucket" data-pack="default" data-tags="images, art, create, color"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-monitor" data-pack="default" data-tags="thunderbolt, screen"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-laptop" data-pack="default" data-tags="macbook, apple, osx"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ipad" data-pack="default" data-tags="tablet, mobile, apple, retina, device"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-iphone" data-pack="default" data-tags="smartphone, mobile, apple, retina, device"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ipod" data-pack="default" data-tags="music, player, apple, retina, device"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-printer" data-pack="default" data-tags="paper"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-usb" data-pack="default" data-tags="digital, computer"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-outlet" data-pack="default" data-tags="digital, computer, electricity"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-bug" data-pack="default" data-tags="develop, program, hacker, error"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-code" data-pack="default" data-tags="develop, program, hacker"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-code-working" data-pack="default" data-tags="develop, program, hacker"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-code-download" data-pack="default" data-tags="develop, program, hacker"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-fork-repo" data-pack="default" data-tags="develop, program, hacker, github"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-network" data-pack="default" data-tags="develop, program, hacker, github"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-pull-request" data-pack="default" data-tags="develop, program, hacker, github"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-merge" data-pack="default" data-tags="develop, program, hacker, github"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-xbox" data-pack="default" data-tags="fun, games"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-playstation" data-pack="default" data-tags="fun, games"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-steam" data-pack="default" data-tags="fun, games"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-closed-captioning" data-pack="default" data-tags="movie, film, television"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-videocamera" data-pack="default" data-tags="movie, film, television"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-film-marker" data-pack="default" data-tags="film, cut, action"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-disc" data-pack="default" data-tags="cd, vinyl"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-headphone" data-pack="default" data-tags="music, earbuds, beats"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-music-note" data-pack="default" data-tags="songs"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-radio-waves" data-pack="default" data-tags="music, sound, speaker"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-speakerphone" data-pack="default" data-tags="sound, speaker, loud, amplify"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-mic-a" data-pack="default" data-tags="sound, talk, speaker"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-mic-b" data-pack="default" data-tags="sound, talk, speaker"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-mic-c" data-pack="default" data-tags="sound, talk, speaker"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-volume-high" data-pack="default" data-tags="sound, noise"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-volume-medium" data-pack="default" data-tags="sound"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-volume-low" data-pack="default" data-tags="sound"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-volume-mute" data-pack="default" data-tags="sound"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-levels" data-pack="default" data-tags="options, toggles, sound, mixer"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-play" data-pack="default" data-tags="music, watch, arrow, right"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-pause" data-pack="default" data-tags="music, break, hold, freeze"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-stop" data-pack="default" data-tags="music, square, hold, freeze"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-record" data-pack="default" data-tags="music, circle"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-skip-forward" data-pack="default" data-tags="music, next"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-skip-backward" data-pack="default" data-tags="music, previous"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-eject" data-pack="default" data-tags="music, dvd, remove"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-bag" data-pack="default" data-tags="shopping, price, cart, money, container, $"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-card" data-pack="default" data-tags="credit, price, debit, money, shopping, cash, dollars, $"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-cash" data-pack="default" data-tags="credit, price, debit, money, shopping, dollars, $"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-pricetag" data-pack="default" data-tags="credit, debit, money, shopping, cash, dollars, $"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-pricetags" data-pack="default" data-tags="credit, debit, money, shopping, cash, dollars, $"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-thumbsup" data-pack="default" data-tags="like, fun, yes"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-thumbsdown" data-pack="default" data-tags="dislike, boring, no"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-happy-outline" data-pack="default" data-tags="good, like, fun, yes"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-happy" data-pack="default" data-tags="good, like, fun, yes"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-sad-outline" data-pack="default" data-tags="cry, bad, no"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-sad" data-pack="default" data-tags="cry, bad, no"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-bowtie" data-pack="default" data-tags="tie, shirt, dress, clothing"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-tshirt-outline" data-pack="default" data-tags="tie, shirt, dress, clothing"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-tshirt" data-pack="default" data-tags="tie, shirt, dress, clothing"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-trophy" data-pack="default" data-tags="competition, compete, win, lose, award"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-podium" data-pack="default" data-tags="competition, compete, win, lose, award"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ribbon-a" data-pack="default" data-tags="competition, compete, win, lose, award, trophy"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ribbon-b" data-pack="default" data-tags="competition, compete, win, lose, award, trophy"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-university" data-pack="default" data-tags="graduate, education, school, tassle"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-magnet" data-pack="default" data-tags="sticky, attraction"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-beaker" data-pack="default" data-tags="mixture, potion, flask"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-erlenmeyer-flask" data-pack="default" data-tags="mixture, potion, beaker, potion"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-egg" data-pack="default" data-tags="birth, twitter, bird, baby"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-earth" data-pack="default" data-tags="nature, globe, home, planet"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-planet" data-pack="default" data-tags="nature, globe, home, planet, space"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-lightbulb" data-pack="default" data-tags="idea, new, aha!"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-cube" data-pack="default" data-tags="box, square, container"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-leaf" data-pack="default" data-tags="green, recycle, plant, nature"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-waterdrop" data-pack="default" data-tags="nature, clean, recycle, fresh, wet, rain"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-flame" data-pack="default" data-tags="fire, hot, heat"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-fireball" data-pack="default" data-tags="hot, heat"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-bonfire" data-pack="default" data-tags="hot, heat"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-umbrella" data-pack="default" data-tags="wet, rain, dry, shelter"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-nuclear" data-pack="default" data-tags="danger, warning, hazard"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-no-smoking" data-pack="default" data-tags="danger, warning, cigarette, cancer"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-thermometer" data-pack="default" data-tags="hot, cold, heat, temperature, mercury"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-speedometer" data-pack="default" data-tags="travel, accelerate"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-model-s" data-pack="default" data-tags="navigation, car, drive, transportation, tesla, sexy"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-plane" data-pack="default" data-tags="fly, jet"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-jet" data-pack="default" data-tags="fly, plane"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-load-a" data-pack="default" data-tags="spinner, waiting, refresh"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-load-b" data-pack="default" data-tags="spinner, waiting, refresh"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-load-c" data-pack="default" data-tags="spinner, waiting, refresh"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-load-d" data-pack="default" data-tags="spinner, waiting, refresh"></i></div>


                            <p><!-- end default icons pack --></p>


                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-ionic-outline" data-pack="ios" data-tags="badass, framework, sexy"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-arrow-back" data-pack="ios" data-tags="chevron, left"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-arrow-forward" data-pack="ios" data-tags="chevron, right"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-arrow-up" data-pack="ios" data-tags="chevron"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-arrow-right" data-pack="ios" data-tags="chevron"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-arrow-down" data-pack="ios" data-tags="chevron"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-arrow-left" data-pack="ios" data-tags="chevron"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-arrow-thin-up" data-pack="ios" data-tags="chevron"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-arrow-thin-right" data-pack="ios" data-tags="chevron"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-arrow-thin-down" data-pack="ios" data-tags="chevron"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-arrow-thin-left" data-pack="ios" data-tags="chevron"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-circle-filled" data-pack="ios" data-tags="checkmark, radio, dot, on, selected, button"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-circle-outline" data-pack="ios" data-tags="checkmark, radio, dot, off, button"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-checkmark-empty" data-pack="ios" data-tags="success, confirmed, on, finished, complete"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-checkmark-outline" data-pack="ios" data-tags="success, confirmed, on, finished, complete"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-checkmark" data-pack="ios" data-tags="success, confirmed, on, finished, complete"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-plus-empty" data-pack="ios" data-tags="add, include, new, invite, +"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-plus-outline" data-pack="ios" data-tags="add, include, new, invite, +"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-plus" data-pack="ios" data-tags="add, include, new, invite, +"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-close-empty" data-pack="ios" data-tags="delete, remove, trash, end, stop, x"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-close-outline" data-pack="ios" data-tags="delete, remove, trash, end, stop, x"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-close" data-pack="ios" data-tags="delete, remove, trash, end, stop, x"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-minus-empty" data-pack="ios" data-tags="hide, remove, minimize, -"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-minus-outline" data-pack="ios" data-tags="hide, remove, minimize, -"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-minus" data-pack="ios" data-tags="hide, remove, minimize, -"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-information-empty" data-pack="ios" data-tags="help, question"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-information-outline" data-pack="ios" data-tags="help, question"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-information" data-pack="ios" data-tags="help, question"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-help-empty" data-pack="ios" data-tags="question, information, ?"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-help-outline" data-pack="ios" data-tags="question, information, ?"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-help" data-pack="ios" data-tags="question, information, ?"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-search" data-pack="ios" data-tags="find, seek, look, magnifying glass"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-search-strong" data-pack="ios" data-tags="find, seek, look, magnifying glass"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-star" data-pack="ios" data-tags="favorite, rate"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-star-half" data-pack="ios" data-tags="favorite, rate"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-star-outline" data-pack="ios" data-tags="favorite, rate"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-heart" data-pack="ios" data-tags="love"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-heart-outline" data-pack="ios" data-tags="love"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-more" data-pack="ios" data-tags="menu"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-more-outline" data-pack="ios" data-tags="menu"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-home" data-pack="ios" data-tags="house"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-home-outline" data-pack="ios" data-tags="house"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-cloud" data-pack="ios" data-tags="storage, weather, whether"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-cloud-outline" data-pack="ios" data-tags="storage, weather, whether"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-cloud-upload" data-pack="ios" data-tags="storage"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-cloud-upload-outline" data-pack="ios" data-tags="storage"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-cloud-download" data-pack="ios" data-tags="storage"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-cloud-download-outline" data-pack="ios" data-tags="storage"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-upload" data-pack="ios" data-tags="share, import"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-upload-outline" data-pack="ios" data-tags="share, import"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-download" data-pack="ios" data-tags="save, export"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-download-outline" data-pack="ios" data-tags="save, export"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-refresh" data-pack="ios" data-tags="reload, renew, reset"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-refresh-outline" data-pack="ios" data-tags="reload, renew, reset"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-refresh-empty" data-pack="ios" data-tags="reload, renew"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-reload" data-pack="ios" data-tags="renew, reset"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-loop-strong" data-pack="ios" data-tags="reload, renew, reset"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-loop" data-pack="ios" data-tags="reload, renew, reset"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-bookmarks" data-pack="ios" data-tags="favorite"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-bookmarks-outline" data-pack="ios" data-tags="favorite"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-book" data-pack="ios" data-tags="favorite, read, literature"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-book-outline" data-pack="ios" data-tags="favorite, read, literature"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-flag" data-pack="ios" data-tags="marker, favorite"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-flag-outline" data-pack="ios" data-tags="marker, favorite"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-glasses" data-pack="ios" data-tags="steve, reading, look, see"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-glasses-outline" data-pack="ios" data-tags="steve, reading, look, see"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-browsers" data-pack="ios" data-tags="square"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-browsers-outline" data-pack="ios" data-tags="square"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-at" data-pack="ios" data-tags="@"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-at-outline" data-pack="ios" data-tags="@"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-pricetag" data-pack="ios" data-tags="shopping, money, items, commerce, $"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-pricetag-outline" data-pack="ios" data-tags="shopping, money, items, commerce, $"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-pricetags" data-pack="ios" data-tags="shopping, money, items, commerce, $"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-pricetags-outline" data-pack="ios" data-tags="shopping, money, items, commerce, $"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-cart" data-pack="ios" data-tags="shopping, money, items, commerce, $"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-cart-outline" data-pack="ios" data-tags="shopping, money, items, commerce, $"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-chatboxes" data-pack="ios" data-tags="talk"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-chatboxes-outline" data-pack="ios" data-tags="talk"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-chatbubble" data-pack="ios" data-tags="talk"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-chatbubble-outline" data-pack="ios" data-tags="talk"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-cog" data-pack="ios" data-tags="settings, gear, options"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-cog-outline" data-pack="ios" data-tags="settings, gear, options"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-gear" data-pack="ios" data-tags="cog, settings, options"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-gear-outline" data-pack="ios" data-tags="cog, settings, options"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-settings" data-pack="ios" data-tags="cog, settings, options"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-settings-strong" data-pack="ios" data-tags="cog, settings, options"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-toggle" data-pack="ios" data-tags="settings, options, switch"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-toggle-outline" data-pack="ios" data-tags="settings, options, switch"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-analytics" data-pack="ios" data-tags="metrics, track, data"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-analytics-outline" data-pack="ios" data-tags="metrics, track, data"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-pie" data-pack="ios" data-tags="cog, settings, options"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-pie-outline" data-pack="ios" data-tags="cog, settings, options"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-pulse" data-pack="ios" data-tags="live, hot, rate"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-pulse-strong" data-pack="ios" data-tags="live, hot, rate"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-filing" data-pack="ios" data-tags="archive"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-filing-outline" data-pack="ios" data-tags="archive"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-box" data-pack="ios" data-tags="archive"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-box-outline" data-pack="ios" data-tags="archive"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-compose" data-pack="ios" data-tags="write, type, create"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-compose-outline" data-pack="ios" data-tags="write, type, create"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-trash" data-pack="ios" data-tags="delete, remove, dispose, waste, basket, dump, kill"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-trash-outline" data-pack="ios" data-tags="delete, remove, dispose, waste, basket, dump, kill"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-copy" data-pack="ios" data-tags="duplicate, paper"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-copy-outline" data-pack="ios" data-tags="duplicate, paper"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-email" data-pack="ios" data-tags="snail, mail"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-email-outline" data-pack="ios" data-tags="snail, mail"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-undo" data-pack="ios" data-tags="reply"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-undo-outline" data-pack="ios" data-tags="reply"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-redo" data-pack="ios" data-tags="forward"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-redo-outline" data-pack="ios" data-tags="forward"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-paperplane" data-pack="ios" data-tags="send"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-paperplane-outline" data-pack="ios" data-tags="send"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-folder" data-pack="ios" data-tags="file"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-folder-outline" data-pack="ios" data-tags="file"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-paper" data-pack="ios" data-tags="feed, paper"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-paper-outline" data-pack="ios" data-tags="feed, paper"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-list" data-pack="ios" data-tags="todo, feed, paper"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-list-outline" data-pack="ios" data-tags="todo, feed, paper"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-world" data-pack="ios" data-tags="globe, earth"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-world-outline" data-pack="ios" data-tags="globe, earth"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-alarm" data-pack="ios" data-tags="wake, ring"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-alarm-outline" data-pack="ios" data-tags="wake, ring"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-speedometer" data-pack="ios" data-tags="speed, drive, level"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-speedometer-outline" data-pack="ios" data-tags="speed, drive, level"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-stopwatch" data-pack="ios" data-tags="time, speed"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-stopwatch-outline" data-pack="ios" data-tags="time, speed"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-timer" data-pack="ios" data-tags="cooking, alarm, buzz"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-timer-outline" data-pack="ios" data-tags="cooking, alarm, buzz"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-clock" data-pack="ios" data-tags="time, date, hours, minutes, seconds, watch"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-clock-outline" data-pack="ios" data-tags="time, date, hours, minutes, seconds, watch"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-time" data-pack="ios" data-tags="clock, watch, hour, minute, second"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-time-outline" data-pack="ios" data-tags="clock, watch, hour, minute, second"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-calendar" data-pack="ios" data-tags="date, time, month, year"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-calendar-outline" data-pack="ios" data-tags="date, time, month, year"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-photos" data-pack="ios" data-tags="images, stills, square"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-photos-outline" data-pack="ios" data-tags="images, stills, square"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-albums" data-pack="ios" data-tags="square, boxes, slides"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-albums-outline" data-pack="ios" data-tags="square, boxes, slides"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-camera" data-pack="ios" data-tags="picture"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-camera-outline" data-pack="ios" data-tags="picture"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-reverse-camera" data-pack="ios" data-tags="picture"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-reverse-camera-outline" data-pack="ios" data-tags="picture"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-eye" data-pack="ios" data-tags="view, see, exposed, look"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-eye-outline" data-pack="ios" data-tags="view, see, exposed, look"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-bolt" data-pack="ios" data-tags="flash, lightning"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-bolt-outline" data-pack="ios" data-tags="flash, lightning"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-color-wand" data-pack="ios" data-tags="camera, picture, edit, magic"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-color-wand-outline" data-pack="ios" data-tags="camera, picture, edit, magic"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-color-filter" data-pack="ios" data-tags="camera, picture"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-color-filter-outline" data-pack="ios" data-tags="camera, picture"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-grid-view" data-pack="ios" data-tags="camera, picture"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-grid-view-outline" data-pack="ios" data-tags="camera, picture"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-crop-strong" data-pack="ios" data-tags="camera, picture, edit"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-crop" data-pack="ios" data-tags="camera, picture, edit"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-barcode" data-pack="ios" data-tags="reader, camera"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-barcode-outline" data-pack="ios" data-tags="reader, camera"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-briefcase" data-pack="ios" data-tags="organize, folder"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-briefcase-outline" data-pack="ios" data-tags="organize, folder"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-medkit" data-pack="ios" data-tags="health, case, first aid, sick, disease"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-medkit-outline" data-pack="ios" data-tags="health, case, first aid, sick, disease"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-medical" data-pack="ios" data-tags="health, case, first aid, sick, disease"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-medical-outline" data-pack="ios" data-tags="health, case, first aid, sick, disease"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-infinite" data-pack="ios" data-tags="forever, loop"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-infinite-outline" data-pack="ios" data-tags="forever, loop"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-calculator" data-pack="ios" data-tags="math, arithmatic"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-calculator-outline" data-pack="ios" data-tags="math, arithmatic"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-keypad" data-pack="ios" data-tags="type, grid, circle"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-keypad-outline" data-pack="ios" data-tags="type, grid, circle"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-telephone" data-pack="ios" data-tags="oldschool, call"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-telephone-outline" data-pack="ios" data-tags="oldschool, call"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-drag" data-pack="ios" data-tags="reorder, move, drag"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-location" data-pack="ios" data-tags="navigation, map, gps, pin"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-location-outline" data-pack="ios" data-tags="navigation, map, gps, pin"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-navigate" data-pack="ios" data-tags="location, map, gps, pin"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-navigate-outline" data-pack="ios" data-tags="location, map, gps, pin"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-locked" data-pack="ios" data-tags="security, padlock, safe"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-locked-outline" data-pack="ios" data-tags="security, padlock, safe"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-unlocked" data-pack="ios" data-tags="security, padlock, safe"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-unlocked-outline" data-pack="ios" data-tags="security, padlock, safe"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-monitor" data-pack="ios" data-tags="thunderbolt, display, screen"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-monitor-outline" data-pack="ios" data-tags="thunderbolt, display, screen"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-printer" data-pack="ios" data-tags="paper"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-printer-outline" data-pack="ios" data-tags="paper"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-game-controller-a" data-pack="ios" data-tags="gaming, nintendo, play"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-game-controller-a-outline" data-pack="ios" data-tags="gaming, nintendo, play"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-game-controller-b" data-pack="ios" data-tags="gaming, nintendo, play"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-game-controller-b-outline" data-pack="ios" data-tags="gaming, nintendo, play"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-americanfootball" data-pack="ios" data-tags="nfl, games, sports, fun, play"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-americanfootball-outline" data-pack="ios" data-tags="nfl, games, sports, fun, play"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-baseball" data-pack="ios" data-tags="mlb, games, sports, fun, play"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-baseball-outline" data-pack="ios" data-tags="mlb, games, sports, fun, play"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-basketball" data-pack="ios" data-tags="nba, games, sports, fun, play"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-basketball-outline" data-pack="ios" data-tags="nba, games, sports, fun, play"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-tennisball" data-pack="ios" data-tags="games, sports, fun, play"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-tennisball-outline" data-pack="ios" data-tags="games, sports, fun, play"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-football" data-pack="ios" data-tags="mls, soccer, games, sports, fun, play"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-football-outline" data-pack="ios" data-tags="mls, soccer, games, sports, fun, play"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-body" data-pack="ios" data-tags="person, users, staff, head, human"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-body-outline" data-pack="ios" data-tags="person, users, staff, head, human"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-person" data-pack="ios" data-tags="users, staff, head, human"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-person-outline" data-pack="ios" data-tags="users, staff, head, human"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-personadd" data-pack="ios" data-tags="users, staff, head, human, new, invite"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-personadd-outline" data-pack="ios" data-tags="users, staff, head, human, new, invite"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-people" data-pack="ios" data-tags="stalker, person, users, head, human"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-people-outline" data-pack="ios" data-tags="stalker, person, users, head, human"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-musical-notes" data-pack="ios" data-tags="sound, noise, listening, play"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-musical-note" data-pack="ios" data-tags="sound, noise, listening, play"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-bell" data-pack="ios" data-tags="right, noise, alarm, sound, music"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-bell-outline" data-pack="ios" data-tags="right, noise, alarm, sound, music"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-mic" data-pack="ios" data-tags="sound, noise, speaker, talk"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-mic-outline" data-pack="ios" data-tags="sound, noise, speaker, talk"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-mic-off" data-pack="ios" data-tags="sound, noise, speaker, talk"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-volume-high" data-pack="ios" data-tags="sound, noise, listen, music"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-volume-low" data-pack="ios" data-tags="sound, noise, listen, music"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-play" data-pack="ios" data-tags="music, watch, arrow, right"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-play-outline" data-pack="ios" data-tags="music, watch, arrow, right"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-pause" data-pack="ios" data-tags="music, break, hold, freeze"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-pause-outline" data-pack="ios" data-tags="music, break, hold, freeze"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-recording" data-pack="ios" data-tags="film, tape, voicemail"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-recording-outline" data-pack="ios" data-tags="film, tape, voicemail"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-fastforward" data-pack="ios" data-tags="next, skip, jump"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-fastforward-outline" data-pack="ios" data-tags="next, skip, jump"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-rewind" data-pack="ios" data-tags="music, previous, back"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-rewind-outline" data-pack="ios" data-tags="music, previous, back"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-skipbackward" data-pack="ios" data-tags="music, previous"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-skipbackward-outline" data-pack="ios" data-tags="music, previous"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-skipforward" data-pack="ios" data-tags="music, next"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-skipforward-outline" data-pack="ios" data-tags="music, next"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-shuffle-strong" data-pack="ios" data-tags="music, next"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-shuffle" data-pack="ios" data-tags="music, next"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-videocam" data-pack="ios" data-tags="film, movie, camera"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-videocam-outline" data-pack="ios" data-tags="film, movie, camera"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-film" data-pack="ios" data-tags="film, movie, camera"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-film-outline" data-pack="ios" data-tags="film, movie, camera"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-flask" data-pack="ios" data-tags="options, mixer, liquid"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-flask-outline" data-pack="ios" data-tags="options, mixer, liquid"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-lightbulb" data-pack="ios" data-tags="idea, new, bright, aha!"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-lightbulb-outline" data-pack="ios" data-tags="idea, new, bright, aha!"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-wineglass" data-pack="ios" data-tags="alcohol, drink, food, glass, drunk, cheers"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-wineglass-outline" data-pack="ios" data-tags="alcohol, drink, food, glass, drunk, cheers"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-pint" data-pack="ios" data-tags="alcohol, drink, food, beer, drunk, cheers"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-pint-outline" data-pack="ios" data-tags="alcohol, drink, food, beer, drunk, cheers"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-nutrition" data-pack="ios" data-tags="health, carrot, food"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-nutrition-outline" data-pack="ios" data-tags="health, carrot, food"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-flower" data-pack="ios" data-tags="nature, spring, leaf, garden"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-flower-outline" data-pack="ios" data-tags="nature, spring, leaf, garden"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-rose" data-pack="ios" data-tags="nature, spring, leaf, garden, flower"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-rose-outline" data-pack="ios" data-tags="nature, spring, leaf, garden, flower"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-paw" data-pack="ios" data-tags="nature, animal, pet, outdoor, track"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-paw-outline" data-pack="ios" data-tags="nature, animal, pet, outdoor, track"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-flame" data-pack="ios" data-tags="fire, hot, burn"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-flame-outline" data-pack="ios" data-tags="fire, hot, burn"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-sunny" data-pack="ios" data-tags="weather, whether, light, sky"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-sunny-outline" data-pack="ios" data-tags="weather, whether, light, sky"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-partlysunny" data-pack="ios" data-tags="light, weather, whether, cloudy"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-partlysunny-outline" data-pack="ios" data-tags="light, weather, whether, cloudy"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-cloudy" data-pack="ios" data-tags="weather, whether, overcast"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-cloudy-outline" data-pack="ios" data-tags="weather, whether, overcast"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-rainy" data-pack="ios" data-tags="whether, weather, water, cloud"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-rainy-outline" data-pack="ios" data-tags="whether, weather, water, cloud"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-thunderstorm" data-pack="ios" data-tags="whether, weather, sky, lightning, rain, cloudy, overcast, storm"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-thunderstorm-outline" data-pack="ios" data-tags="whether, weather, sky, lightning, rain, cloudy, overcast, storm"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-snowy" data-pack="ios" data-tags="cold, weather, whether, overcast"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-moon" data-pack="ios" data-tags="sky, night, dark"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-moon-outline" data-pack="ios" data-tags="sky, night, dark"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-cloudy-night" data-pack="ios" data-tags="weather, whether, overcast"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-ios-cloudy-night-outline" data-pack="ios" data-tags="weather, whether, overcast"></i></div>


                            <p><!-- end iOS 7-style icons pack --></p>


                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-arrow-up" data-pack="android" data-tags="chevron, navigation"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-arrow-forward" data-pack="android" data-tags="chevron, navigation"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-arrow-down" data-pack="android" data-tags="chevron, navigation"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-arrow-back" data-pack="android" data-tags="chevron, navigation"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-arrow-dropup" data-pack="android" data-tags="chevron, navigation"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-arrow-dropup-circle" data-pack="android" data-tags="chevron, navigation"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-arrow-dropright" data-pack="android" data-tags="chevron, navigation"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-arrow-dropright-circle" data-pack="android" data-tags="chevron, navigation"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-arrow-dropdown" data-pack="android" data-tags="chevron, navigation"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-arrow-dropdown-circle" data-pack="android" data-tags="chevron, navigation"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-arrow-dropleft" data-pack="android" data-tags="chevron, navigation"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-arrow-dropleft-circle" data-pack="android" data-tags="chevron, navigation"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-add" data-pack="android" data-tags="plus, include, invite"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-add-circle" data-pack="android" data-tags="plus, include, invite"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-remove" data-pack="android" data-tags="minus, subtract, delete"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-remove-circle" data-pack="android" data-tags="minus, subtract, delete"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-close" data-pack="android" data-tags="delete, remove"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-cancel" data-pack="android" data-tags="delete, remove"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-radio-button-off" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-radio-button-on" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-checkmark-circle" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-checkbox-outline-blank" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-checkbox-outline" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-checkbox-blank" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-checkbox" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-done" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-done-all" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-menu" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-more-horizontal" data-pack="android" data-tags="options, menu"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-more-vertical" data-pack="android" data-tags="options, menu"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-refresh" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-sync" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-wifi" data-pack="android" data-tags="internet,connection, bars"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-call" data-pack="android" data-tags="telephone"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-apps" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-settings" data-pack="android" data-tags="options"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-options" data-pack="android" data-tags="settings, mixer"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-funnel" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-search" data-pack="android" data-tags="magnifying glass"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-home" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-cloud-outline" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-cloud" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-download" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-upload" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-cloud-done" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-cloud-circle" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-favorite-outline" data-pack="android" data-tags="favorite, like, rate"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-favorite" data-pack="android" data-tags="favorite, like, rate"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-star-outline" data-pack="android" data-tags="favorite, like, rate"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-star-half" data-pack="android" data-tags="favorite, like, rate"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-star" data-pack="android" data-tags="favorite, like, rate"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-calendar" data-pack="android" data-tags="clock"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-alarm-clock" data-pack="android" data-tags="clock"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-time" data-pack="android" data-tags="clock"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-stopwatch" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-watch" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-locate" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-navigate" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-pin" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-compass" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-map" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-walk" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-bicycle" data-pack="android" data-tags="move, bike, transportation, maps"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-car" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-bus" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-subway" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-train" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-boat" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-plane" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-restaurant" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-bar" data-pack="android" data-tags="wine, drink, food, dinner"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-cart" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-camera" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-image" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-film" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-color-palette" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-create" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-mail" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-drafts" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-send" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-archive" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-delete" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-attach" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-share" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-share-alt" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-bookmark" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-document" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-clipboard" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-list" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-folder-open" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-folder" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-print" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-open" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-exit" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-contract" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-expand" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-globe" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-chat" data-pack="android" data-tags="talk, text"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-textsms" data-pack="android" data-tags="talk, text"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-hangout" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-happy" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-sad" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-person" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-people" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-person-add" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-contact" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-contacts" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-playstore" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-lock" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-unlock" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-microphone" data-pack="android" data-tags="recorder, speak, noise, music, sound"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-microphone-off" data-pack="android" data-tags="recorder, speak, noise, music, sound, mute"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-notifications-none" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-notifications" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-notifications-off" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-volume-mute" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-volume-down" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-volume-up" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-volume-off" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-hand" data-pack="android" data-tags="stop"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-desktop" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-laptop" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-phone-portrait" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-phone-landscape" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-bulb" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-sunny" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-alert" data-pack="android" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-android-warning" data-pack="android" data-tags=""></i></div>
						  ...
						  -->
                            ...
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-twitter" data-pack="social" data-tags="follow, post, share"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-twitter-outline" data-pack="social" data-tags="follow, post, share"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-facebook" data-pack="social" data-tags="like, post, share"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-facebook-outline" data-pack="social" data-tags="like, post, share"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-googleplus" data-pack="social" data-tags="follow, post, share"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-googleplus-outline" data-pack="social" data-tags="follow, post, share"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-google" data-pack="social" data-tags="follow, post, share"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-google-outline" data-pack="social" data-tags="follow, post, share"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-dribbble" data-pack="social" data-tags="design"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-dribbble-outline" data-pack="social" data-tags="design"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-octocat" data-pack="social" data-tags="code, github, fork, merge, clone"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-github" data-pack="social" data-tags="code, fork, merge, clone"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-github-outline" data-pack="social" data-tags="code, fork, merge, clone"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-instagram" data-pack="social" data-tags="photo, camera, facebook"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-instagram-outline" data-pack="social" data-tags="photo, camera, facebook"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-whatsapp" data-pack="social" data-tags="text, sharing, private, facebook"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-whatsapp-outline" data-pack="social" data-tags="text, sharing, private, facebook"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-snapchat" data-pack="social" data-tags="photos, app"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-snapchat-outline" data-pack="social" data-tags="photos, app"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-foursquare" data-pack="social" data-tags="checkin"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-foursquare-outline" data-pack="social" data-tags="checkin"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-pinterest" data-pack="social" data-tags="social"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-pinterest-outline" data-pack="social" data-tags="social"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-rss" data-pack="social" data-tags="blogging"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-rss-outline" data-pack="social" data-tags="blogging"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-tumblr" data-pack="social" data-tags="blogging"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-tumblr-outline" data-pack="social" data-tags="blogging"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-wordpress" data-pack="social" data-tags="blogging"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-wordpress-outline" data-pack="social" data-tags="blogging"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-reddit" data-pack="social" data-tags="news, upvotes, karma"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-reddit-outline" data-pack="social" data-tags="news, upvotes, karma"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-hackernews" data-pack="social" data-tags="discuss, upvotes, karma"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-hackernews-outline" data-pack="social" data-tags="discuss, upvotes, karma"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-designernews" data-pack="social" data-tags="design, post"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-designernews-outline" data-pack="social" data-tags="design, post"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-yahoo" data-pack="social" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-yahoo-outline" data-pack="social" data-tags=""></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-buffer" data-pack="social" data-tags="share"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-buffer-outline" data-pack="social" data-tags="share"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-skype" data-pack="social" data-tags="call"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-skype-outline" data-pack="social" data-tags="call"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-linkedin" data-pack="social" data-tags="connect"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-linkedin-outline" data-pack="social" data-tags="connect"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-vimeo" data-pack="social" data-tags="video, watch, share, view"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-vimeo-outline" data-pack="social" data-tags="video, watch, share, view"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-twitch" data-pack="social" data-tags="gaming, games, live, streaming, video, watch, share, view"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-twitch-outline" data-pack="social" data-tags="gaming, games, live, streaming, video, watch, share, view"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-youtube" data-pack="social" data-tags="video, watch, share, view"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-youtube-outline" data-pack="social" data-tags="video, watch, share, view"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-dropbox" data-pack="social" data-tags="upload"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-dropbox-outline" data-pack="social" data-tags="upload"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-apple" data-pack="social" data-tags="mac, mobile"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-apple-outline" data-pack="social" data-tags="mac, mobile"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-android" data-pack="social" data-tags="mobile"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-android-outline" data-pack="social" data-tags="mobile"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-windows" data-pack="social" data-tags="pc"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-windows-outline" data-pack="social" data-tags="pc"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-html5" data-pack="social" data-tags="code, html, css, js, developer"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-html5-outline" data-pack="social" data-tags="code, html, css, js, developer"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-css3" data-pack="social" data-tags="code, html, css, js, developer"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-css3-outline" data-pack="social" data-tags="code, html, css, js, developer"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-javascript" data-pack="social" data-tags="code, html, css, js, developer"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-javascript-outline" data-pack="social" data-tags="code, html, css, js, developer"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-angular" data-pack="social" data-tags="code, mobile, js, angularjs, ionic"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-angular-outline" data-pack="social" data-tags="code, mobile, js, angularjs, ionic"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-nodejs" data-pack="social" data-tags="code, js, javascript, developer"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-sass" data-pack="social" data-tags="code, css"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-python" data-pack="social" data-tags="code"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-chrome" data-pack="social" data-tags="code, mobile, js, angularjs, ionic"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-chrome-outline" data-pack="social" data-tags="code, mobile, js, angularjs, ionic"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-codepen" data-pack="social" data-tags="testing, js, developer"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-codepen-outline" data-pack="social" data-tags="testing, js, developer"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-markdown" data-pack="social" data-tags="code, testing, text, developer"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-tux" data-pack="social" data-tags="code, linux, opensource"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-freebsd-devil" data-pack="social" data-tags="code, opensource, unix"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-usd" data-pack="social" data-tags="currency, trade, money, cash"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-usd-outline" data-pack="social" data-tags="currency, trade, money, cash"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-bitcoin" data-pack="social" data-tags="currency, trade, money"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-bitcoin-outline" data-pack="social" data-tags="currency, trade, money"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-yen" data-pack="social" data-tags="currency, trade, money, japanese"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-yen-outline" data-pack="social" data-tags="currency, trade, money, japanese"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-euro" data-pack="social" data-tags="currency, trade, money, europe"></i></div>
                            <div class="ion-hover col-md-3 col-sm-4"><i class="ion-social-euro-outline" data-pack="social" data-tags="currency, trade, money, europe"></i></div>
                ...
                <div class="tab-pane" id="themify">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">OK &amp; Yön iconları</h4>
                            ...
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">Web Uygulama iconları</h4>
                                    <div class="icon-list-demo row">
                            ...
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">Kontrol iconları</h4>
                                    <div class="icon-list-demo row">
                            ...
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">Metin Editorü iconları</h4>
                                    <div class="icon-list-demo row">
                            ...
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">Düzen iconları</h4>
                                    <div class="icon-list-demo row">
                            ...
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">Marka iconları</h4>
                                    <div class="icon-list-demo row">
