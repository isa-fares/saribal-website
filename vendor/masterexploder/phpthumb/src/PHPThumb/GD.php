...
class GD extends PHPThumb
{
     ...
     * @return \PHPThumb\GD
     */
    public function adaptiveResize($width, $height, $center = true)
    {
        // make sure our arguments are valid
    ...
    public function show($rawData = false)
    {
        ...
        switch ($this->format) {
            ...
            case 'JPG':
                ...
                imagewebp($this->oldImage, null, $this->options['jpegQuality']);
                break;
            case 'PNG':
            case 'STRING':
                if ($rawData === false) {
    ...
    public function save($fileName, $format = null)
    {
        ...
        switch ($format) {
            ...
            case 'PNG':
                ...
                break;
            case 'WEBP':
                imagewebp($this->oldImage, $fileName, $this->options['jpegQuality'] );
            break;
        }
    ...
    protected function preserveAlpha()
    {
        ...
        if ($this->format == 'WEBP' && $this->options['preserveAlpha'] === true) {
            imagealphablending($this->workingImage, false);
